...
function Clients() {
  return (
    ...
    >
      <h1 class="md:mt-48  px-12 text-white md:text-7xl text-5xl md:mb-48 mb-24 text-center font-heading underline decoration-6 underline-offset-6 decoration-dbluee">
        Clients
      </h1>
      <div
        class="flex 
      ...
      >
        <img src={defi} class="h-16 mb-12"></img>
        <img src={phuture} class="md:h-16 mb-12"></img>
        <img
