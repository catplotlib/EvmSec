...
function Hero() {
  return (
    ...
    <div class="relative flex flex-col justify-center h-screen items-center">
      ...
      <h1 class="md:mb-24 mb-32 px-12 text-white md:text-7xl text-4xl text-center font-heading ">
        Helping you launch your <span class="text-red">web3 protocols.</span>
      </h1>
      <ReactTypingEffect
        speed="80"
        eraseSpeed="0"
        className="absolute bottom-24 text-white md:text-xl text-center font-mono w-2/3"
        staticText={[
